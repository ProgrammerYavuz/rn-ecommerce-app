...
export default function Home() {
  ...
  const categories = [{ id: "all", name: "Tümü", icon: "grid" }, ...CATEGORIES];
  ...
  return (
    <SafeAreaView className="flex-1" edges={["top"]}>
      <Header title="averon" showMenu showLogo showCart />
      ...
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-6">
          <View className="flex-row justify-between items-center mb-4">
            <Text className="text-xl text-primary font-bold">Kategoriler</Text>
          </View>
        ...
        <View className="mb-4">
          <View className="flex-row justify-between items-center mb-4">
            ...
            <TouchableOpacity onPress={() => router.push("/shop")}>
              <Text className="text-secondary text-sm">Daha Fazla</Text>
            </TouchableOpacity>
          </View>
          {loading ? (
        ...
        <View className="bg-gray-100 p-6 rounded-2xl mb-20 items-center">
          ...
          <Text className="text-secondary mb-4 text-center">
            Özel kampanyalardan haberdar olmak ve ilk siparişinde %10 indirim
            kazanmak için abone ol.
          </Text>
          <TouchableOpacity className="w-4/5 items-center bg-primary rounded-full py-3">
            <Text className="text-base text-white font-bold">Abone Ol</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
