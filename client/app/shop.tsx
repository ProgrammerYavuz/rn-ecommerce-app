...
export default function Shop() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-surface" edges={["top"]}>
      <Header title="Tüm Ürünler" showBack showCart />
      <View className="flex-row gap-2 mb-3 mx-4 mt-2">
        ...
        <TouchableOpacity className="w-12 h-12 items-center justify-center rounded-xl bg-gray-800">
          ...
          ListEmptyComponent={
            !loading && (
              <View className="flex-1 items-center justify-center py-20">
                <Text className="text-secondary">Ürün bulunamadı!</Text>
              </View>
            )
          }
        />
